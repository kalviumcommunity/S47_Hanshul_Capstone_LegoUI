...
export default function NavBar({ toggleSidebar }) {
  ...
  const handleJWTLogout = async () => {
    try {
      ...
      // console.log("logout userr token", token)
      if (!token) {
  ...
  const handleLogout = () => {
    if (user?.provider === 'JWT') {
      handleJWTLogout();
      console.log("user loggout using jwt");
      
    } else {
      googleLogout();
      console.log("user loggout using google");
    }
  };
      ...
      <header>
        <nav className={nav.navbar}>
          ...
          <div className={nav.rightnav}>
            ...
            <div className={nav.loginuser} onClick={() => setopen(!open)}>
              <img
        ...
        >
          <ul>
            <Link className={nav.link} to="/profile">
              <li onClick={() => setopen(false)} className={nav.profileList}>
                Profile
              </li>
            </Link>
